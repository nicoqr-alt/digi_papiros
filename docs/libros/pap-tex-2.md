...
## Cómo citar
> Mónica Clapp. (2999.0). *Análisis Matemático*. Instituto de Matemáticas, UNAM, 0.0

<details>
  <summary>BibTeX</summary>
  <p style="font-family:'Courier New'">@BOOK{pap-tex-2, <br>title = {Análisis Matemático}, <br>author = {Clapp, Mónica}, <br>year = {2999.0}, <br>publisher = {Instituto de Matemáticas, UNAM}, <br>address = {México}} </p>
</details>
