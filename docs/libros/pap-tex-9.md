...
## Cómo citar
> Felipe Zaldivar. (2999.0). *Introducción al álgebra lineal*. Instituto de Matemáticas, UNAM, 0.0

<details>
  <summary>BibTeX</summary>
  <p style="font-family:'Courier New'">@BOOK{pap-tex-9, <br>title = {Introducción al álgebra lineal}, <br>author = {Zaldivar, Felipe}, <br>year = {2999.0}, <br>publisher = {Instituto de Matemáticas, UNAM}, <br>address = {México}} </p>
</details>
