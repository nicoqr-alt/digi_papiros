...
<details>
  ...
  <p style="font-family:'Courier New'">@BOOK{pap-tex-9, <br>title = {Introducción al álgebra lineal}, <br>author = {Zaldivar, Felipe}, <br>year = {2999}, <br>publisher = {Instituto de Matemáticas, UNAM}, <br>address = {México}} </p>
</details>
