...
tags: [Papirhos, Textos, 2016.0]
---
# Grupos II
<div class = "chips"><span class ="chip"></span class ="icon">🏷</span> Textos</span> <span class ="chip"></span class ="icon">📚</span> Papirhos</span> <span class ="chip"></span class ="icon">🗓</span> 2016.0</span> <span class ="chip"></span class ="icon">ℹ️</span> Publicado</span></div>
...
## Cómo citar
> Diana Avella, Octavio Mendoza, Edith, Corina Saenz, Valadez, María, José Souto. (2016.0). *Grupos II*. Instituto de Matemáticas, UNAM, 1.0

<details>
  <summary>BibTeX</summary>
  <p style="font-family:'Courier New'">@BOOK{pap-tex-4, <br>title = {Grupos II}, <br>author = {Avella, Diana and Mendoza, Octavio and Saenz, Edith and Souto, María}, <br>year = {2016.0}, <br>publisher = {Instituto de Matemáticas, UNAM}, <br>address = {México}} </p>
</details>
